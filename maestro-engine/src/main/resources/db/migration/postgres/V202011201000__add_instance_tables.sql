...
CREATE TABLE IF NOT EXISTS maestro_workflow_instance (  -- table of workflow runs
  workflow_id       TEXT GENERATED ALWAYS AS (instance->>'workflow_id') STORED NOT NULL,
  ...
  uuid              TEXT GENERATED ALWAYS AS (instance->>'workflow_uuid') STORED NOT NULL,       -- unique id for idempotency
...
CREATE TABLE IF NOT EXISTS maestro_step_instance (
  ...
  step_id                   TEXT GENERATED ALWAYS AS (instance->>'step_id') STORED NOT NULL,
