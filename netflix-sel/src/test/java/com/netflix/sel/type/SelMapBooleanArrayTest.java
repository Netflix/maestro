...
public class SelMapBooleanArrayTest {
  ...
  public void setUp() throws Exception {
    ...
    map.put("foo", new boolean[] {true, false});
    orig = SelMap.of(map);
  }
  ...
  public void testAssignOp() {
    ...
    assertEquals("MAP: {foo=[true, false]}", cur.type() + ": " + cur.toString());
  ...
  public void testUnbox() {
    ...
    assertEquals("[true, false]", Arrays.toString((boolean[]) map.get("foo")));
  }

  @Test
  public void testCallGet() {
    SelType res = orig.call("get", new SelType[] {SelString.of("foo")});
    assertEquals("BOOLEAN_ARRAY: [true, false]", res.type() + ": " + res.toString());
  ...
  public void testCallPut() {
    SelType res =
        orig.call(
            "put",
            new SelType[] {
              SelString.of("foo"), SelArray.of(new boolean[] {false, true}, SelTypes.BOOLEAN_ARRAY)
            });
    assertEquals("BOOLEAN_ARRAY: [true, false]", res.type() + ": " + res.toString());
    res = orig.call("get", new SelType[] {SelString.of("foo")});
    assertEquals("BOOLEAN_ARRAY: [false, true]", res.type() + ": " + res.toString());
