...
public class SelMapLongTest {
  ...
  public void testAssignOp() {
    ...
    assertEquals("MAP: {foo=123}", cur.type() + ": " + cur.toString());
  ...
  public void testUnbox() {
    ...
    assertEquals("{foo=123}", String.valueOf(map));
    assertEquals(Long.class, map.get("foo").getClass());
  }
  ...
  public void testCallPut() {
    SelType res = orig.call("put", new SelType[] {SelString.of("foo"), SelLong.of(111)});
    assertEquals("LONG: 123", res.type() + ": " + res.toString());
    res = orig.call("get", new SelType[] {SelString.of("foo")});
    assertEquals("LONG: 111", res.type() + ": " + res.toString());
    res = orig.call("put", new SelType[] {SelString.of("foo"), SelType.NULL});
    assertEquals("LONG: 111", res.type() + ": " + res.toString());
    res = orig.call("get", new SelType[] {SelString.of("foo")});
    assertEquals("NULL: NULL", res.type() + ": " + res.toString());
    res = orig.call("put", new SelType[] {SelString.of("fuu"), SelLong.of(222)});
    assertEquals(SelType.NULL, res);
    res = orig.call("get", new SelType[] {SelString.of("fuu")});
    assertEquals("LONG: 222", res.type() + ": " + res.toString());
  }
}
