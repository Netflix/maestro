...
public class StepInstanceUpdateJobEvent implements MaestroJobEvent {
  ...
  private String stepUuid; // internal UUID to identify this step run
  private String correlationId; // default to the workflow instance uuid
  private long stepInstanceId; // step sequence number.
  private List<StepInstancePendingRecord> pendingRecords;
  ...
  @Override
  public Type getType() {
    return Type.STEP_INSTANCE_UPDATE;
  }
  ...
  public static class StepInstancePendingRecord {
    private StepInstance.Status oldStatus;
    private StepInstance.Status newStatus;
