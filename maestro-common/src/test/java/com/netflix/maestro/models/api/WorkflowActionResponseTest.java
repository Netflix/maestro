...
public class WorkflowActionResponseTest extends MaestroBaseTest {
  @Test
  public void testRoundTripSerdeForActivate() throws Exception {
    WorkflowActionResponse response =
        loadObject(
            "fixtures/api/sample-workflow-activate-response.json", WorkflowActionResponse.class);
    assertEquals(
        response,
