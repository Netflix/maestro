...
public class MaestroBadRequestException extends MaestroRuntimeException {
   ...
   */
  public MaestroBadRequestException(Throwable cause, String msg, String... errors) {
   ...
   */
  public MaestroBadRequestException(List<String> errors, String template, Object... args) {
