...
@JsonPropertyOrder(
    ...
    alphabetic = true)
@JsonDeserialize(builder = WorkflowVersionChangeEvent.WorkflowVersionChangeEventBuilderImpl.class)
@SuperBuilder(toBuilder = true)
@Getter
@ToString(callSuper = true)
@EqualsAndHashCode(callSuper = true)
public final class WorkflowVersionChangeEvent extends WorkflowChangeEvent {
  ...
  @Override
  public Type getType() {
    return Type.WORKFLOW_VERSION_CHANGE_EVENT;
  }

  /** builder class for lombok and jackson. */
  @JsonPOJOBuilder(withPrefix = "")
  @JsonNaming(PropertyNamingStrategy.SnakeCaseStrategy.class)
  static final class WorkflowVersionChangeEventBuilderImpl
      extends WorkflowVersionChangeEventBuilder<
          WorkflowVersionChangeEvent, WorkflowVersionChangeEventBuilderImpl> {}
}
