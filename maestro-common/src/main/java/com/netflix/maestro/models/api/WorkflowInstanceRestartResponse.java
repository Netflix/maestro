...
@JsonPropertyOrder(
    ...
    alphabetic = true)
@JsonDeserialize(
    builder = WorkflowInstanceRestartResponse.WorkflowInstanceRestartResponseBuilder.class)
@Builder
@Getter
@ToString
@EqualsAndHashCode
public class WorkflowInstanceRestartResponse {
  ...
  public static final class WorkflowInstanceRestartResponseBuilder {}
}
